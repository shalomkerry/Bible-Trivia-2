const questions = [
  ...
  {
    question:
      "His hand shall be against every man, And every man’s hand against him.(NKJV)</br>Who was this prophecy about?",
    answer: [
  ...
  {
    question:
      "I go the way of all the earth; be strong, therefore, and prove  yourself a man.(NKJV)<br>Whose advice is this?",
    answer: [
  ...
  {
    question:
      "For I say to you that God is able to raise up children to Abraham from these stones.(NKJV)<br>Who said this?",
    answer: [
  ...
  {
    question: "How many letters did Paul the Apostle write?",
    answer: [
  ...
  {
    question: "He must increase, but I must decrease.(NKJV)<br>Who said this?",
    answer: [
  ...
  {
    question:
      "When you till the ground, it shall no longer yield its strength to you(NKJV)<br>This curse was for?",
    answer: [
  ...
  {
    question:
      "If they do not hear Moses and the prophets, neither will they be persuaded though one rise from the dead(NKJV)<br>Which parable?",
    answer: [
...
const answerElement = document.querySelector("#buttons");
